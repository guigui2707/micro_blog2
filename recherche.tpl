...
{if ({$nbResultat}==0)}	
		<h1 style="text-align:center"> Nous avons trouvé aucun résultat à votre recherche</h1>
...
{foreach from=$tableau item=donnees}
      ...
      <blockquote>
          ...
          {if $donnees.nom == $nom || $nom=="Administrateur"}
              <a href="index.php?idMessage={$donnees.idMessage}" class="btn btn-primary" >Modifier</a> <!-- On envoit un parametre message  -->
